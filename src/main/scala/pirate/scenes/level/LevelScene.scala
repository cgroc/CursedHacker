          ...
          Outcome(
            LevelModel.Ready(
              ...
              Map(
                ...
                Screen.Two -> List(
                  otherItvCharacter(CharacterName.Shah, Vertex(10, 0)),
                  otherItvCharacter(CharacterName.Ali, Vertex(14, 0)),
                  otherItvCharacter(CharacterName.Chloe, Vertex(5, 0)),
                  otherItvCharacter(CharacterName.Chris, Vertex(7, 0))
                ),
                Screen.Three -> List(
                  otherItvCharacter(CharacterName.Pere, Vertex(12, 0)),
                  otherItvCharacter(CharacterName.James, Vertex(5, 0)),
                  otherItvCharacter(CharacterName.Miles, Vertex(14, 0)),
                  otherItvCharacter(CharacterName.Adam, Vertex(7, 0)),
                  otherItvCharacter(CharacterName.Waltons, Vertex(9, 0))
                ),
                Screen.Four -> List(
                ...
                Screen.End -> List.empty
              ),
              Platform.fromTerrainMap(levelDataStore.terrainMap),
              Platform.fromTerrainMap(levelDataStore.terrainMapNoLeftDoor)
            )
          )
  ...
  def updateViewModel(
    ...
    case FrameTick =>
      model match {
        ...
        case LevelModel.Ready(_, dave, characters, _, _) =>
  ...
  def present(
    ...
    Outcome(
      (model, viewModel) match {
        case (m @ LevelModel.Ready(_, _, _, _, _), vm @ LevelViewModel.Ready(_)) =>
          LevelView
            .draw(
              context.gameTime,
              m,
